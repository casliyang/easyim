...
public class MessageConvertForSys implements MessageConverter {
	...
	public Message toMessage(Object object, Session session)
		...
		objectMessage.setStringProperty("content", msg[0]);
		objectMessage.setStringProperty("sender", msg[1]);
		objectMessage.setStringProperty("receiver", msg[2]);
		objectMessage.setStringProperty("conversationID", msg[3]);
		objectMessage.setStringProperty("sendTime", msg[4]);
	...
	public Object fromMessage(Message message) throws JMSException,MessageConversionException {
		...
		return objectMessage.getObjectProperty("content");
	}
}
